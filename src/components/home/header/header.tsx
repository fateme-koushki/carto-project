  ...
  return (
    ...
    <div className='flex justify-between mx-auto  '>
       ...
       <Image  src={iphone}  alt='phones' className='w-[250px] md:w-[370px] lg:w-[400px] h-full object-contain mt-10 mx-auto text-center' />
        <div className='w-72 md:w-[700px] text-start md:text-center h-full'>
          <h2 className='flex-wrap md:leading-[60px] text-3xl md:text-5xl font-bold  '>
            
            بهترین معاملات  وب را  در سایت ما کشف کنید</h2>
        ...
        <div className='flex gap-4 mt-5'>
              ...
              <Link  className='text-lg border border-primary text-primary rounded-lg w-36 py-[2px] hover:bg-primary hover:text-white ' href={"/"} >بیشتر بدانید</Link  >
            </div>
       </div>
